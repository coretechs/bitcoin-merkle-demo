...
function merklize (txArr) {
	...
	while(txArr.length) {
		...
		let res = sha256.digest(sha256.digest(node1.concat(node2)));
...
// To prove that 5bab is in the block, all we need is 5d85 and 4139

let nodesArr = ["5d85399ada11cfc184f400ec46f2deba9f2a475e70e83d3c34e4eff5e33a3aae",
"5bab4a2f361e22004f62764e7634e166600089d4659756e8b5f3ed677e3a06d8",
"4139e3d2ea370d085e78025c2a9b36641c8ddc4e38919b7ae6260666d9c476eb"]

// convert hex to little-endian byte arrays
let nodes = nodesArr.map(n => hexToByteArr(n).reverse());
